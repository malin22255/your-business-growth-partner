  ...
  const clients = [
    {
      ...
      industry: "金融银行",
      description: "为宁波银行客户提供专属权益，提升客户活跃度与忠诚度",
    ...
    },
    {
      ...
      industry: "交通出行",
      description: "为地铁乘客提供多元化福利权益，增强出行体验",
    ...
    },
    {
      ...
      industry: "政务服务",
      description: "助力政府惠民工程，为市民提供优质生活权益",
    ...
    },
    {
      ...
      industry: "海洋产业",
      description: "为渔业从业者提供专属福利，提升行业归属感",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-foreground mb-8 leading-tight">
            <span className="text-gradient-blue">政企标杆</span>客户
            <br />信赖之选
          </h2>
            ...
            >
              ...
              <div className="relative z-10 p-8 md:p-10">
                ...
                <div className="flex gap-8 pt-6 border-t border-border/50">
                  <div>
                    <div className="text-2xl font-bold text-brand-gold">{client.stats.users}</div>
